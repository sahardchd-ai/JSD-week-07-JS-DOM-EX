...
const headNew = document.getElementById("heading");
headNew.textContent = "Welcome!";
...
const bioNew = document.getElementById("bio");
bioNew.innerHTML = `I am <strong>learning</strong>`

// TODO 3: Select #card. Read its "class" attribute with getAttribute and
// console.log() it.
const cardCheckAttr = document.getElementById("card");
console.log(cardCheckAttr.getAttribute("class"));
...
const cardAddClass = document.getElementById("card");

cardAddClass.classList.add('highlight');
console.log(cardAddClass.className);
...
const dataVisit = document.getElementById("card");
let dataVisit1 = Number(dataVisit.dataset.visits)+1;
// dataVisit1++;
dataVisit.dataset.visits = dataVisit1;
console.log(dataVisit.dataset.visits);
// console.log(dataVisit1);
